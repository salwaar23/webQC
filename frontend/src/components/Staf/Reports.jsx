...
function stafreports(){
    ...
    const saveLaporan = async (e) => {
        ...
        try {
            ...
            alert("Terima kasih, data kualitas sudah ditambahkan")
            navigate("/staf");
        } catch (error) {
            console.log(error);
        }
    ...
    return(
        <div>
            ...
            <div className="inline-flex ml-[200px] mt-[20px]">
                <div>
                ...
                <div className="-mt-[10px] mr-[100px]">
                    <img className="h-[450px] w-[670px]" src={img}/>
                </div>
            </div><br/>
            <div className="inline-flex ml-[480px] mt-[20px]">
                ...
                <Link to={`/staf`}><div className="bg-red-500 w-[80px] text-center ml-3 rounded-md pt-[3px] text-white">Kembali</div></Link>
            </div>
            </form>
        </div>
