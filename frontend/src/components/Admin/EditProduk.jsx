...
const EditProduk = () => {
    ...
    const getProdukById = async () => {
        ...
        setjenisproduk(response.data.jenis_produk);
        setjeniskain(response.data.jenis_kain);
    ...
    return(
        <div>
            <div className="text-center mt-10 text-2xl">Edit Data Produk PT. MDS Textile</div>
            ...
            <div><form onSubmit={updateProduk}><div className="inline-flex mt-[40px] ml-[80px]">
                <div className="">
