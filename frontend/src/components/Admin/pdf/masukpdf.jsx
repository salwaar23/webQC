    ...
    <Document>
      <Page size="A4">
        <View style={styles.table1}>  
          ...
          <Text style={styles.text3}>Data Barang Masuk</Text>
        ...
        <View style={styles.tableRow} key={masuk.id}> 
          <View style={styles.tableCol1}> 
            <Text style={styles.tableCell}>{index + 1}</Text> 
          </View> 
          <View style={styles.tableCol}> 
            <Text style={styles.tableCell}>{masuk.kode_barang}</Text> 
          </View> 
          <View style={styles.tableCol}>
            <Text style={styles.tableCell}>{masuk.nama_barang}</Text> 
          </View>
          <View style={styles.tableCol3}> 
            <Text style={styles.tableCell}>{masuk.jumlah}</Text> 
          </View> 
          <View style={styles.tableCol2}> 
            <Text style={styles.tableCell}>{masuk.kualitas}</Text> 
          </View> 
          <View style={styles.tableCol4}> 
            <Text style={styles.tableCell}>{masuk.tgl_masuk}</Text> 
          </View> 
        </View> 
        ))}
      </View>
