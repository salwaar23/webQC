...
const EditKeluar = () => {
    ...
    const getKeluarById = async () =>{
        ...
        settgl(response.data.tgl_keluar);
    }

    return(
        <div>
            <div className="text-center mt-10 text-2xl">Edit Data Barang keluar PT. MDS Textile</div>
            ...
            <div><form onSubmit={updateKeluar}><div className="inline-flex mt-[40px] ml-[80px]">
                <div className="">
